...
activities = {
    ...
    "Swimming Club": {
        ...
        "max_participants": 18,
        "participants": ["aiden@mergington.edu", "rachel@mergington.edu"]
    },
    "Art Club": {
    ...
    "Drama Club": {
        "description": "Rehearse performances and build theater skills",
    ...
    "Science Olympiad": {
        "description": "Explore science topics through team-based events and experiments",
